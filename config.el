...
(setq user-full-name "Bryan Riddle"
      user-mail-address "bryanlovesdata@gmail.com")
...
(setq org-directory "~/Dropbox/org/roam/dailies")
...
(use-package deft
      ...
      (deft-default-extension "org sql")
...
(setq org-columns-default-format "%35ITEM(Task) %TODO %10CATEGORY %3PRIORITY %TAGS %8AoR(AoR) %10Effort(Effort){:} %10CLOCKSUM")
